...
=====================================================
Mirrors the frontend's ``types/source.ts`` interface.
Used by admin source management and the document ingestion pipeline.
"""
...
SourceStatus = str  # "queued" | "processing" | "indexed" | "error"
...
class UploadResponse(BaseModel):
    ...
    status: str = Field("queued", description="'queued' | 'processing' | 'indexed'.")
